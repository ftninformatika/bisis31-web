...
><@autor/><@naslov/><@naslov2/><@deoKnj/><@naslovDeo/><@mesto/><@izdavac/><@godIzd/><@brStr/><@dimenzije/><@zbirka/><@napomene1/><@isbnBroj/><@UDC/><@signatura1/><@signaturaX/><#--
...
></#if
><#if signX!="" 
   ><#assign web=web+"<TR><TD valign=top width=\"18%\"><i><B>"+signaturaPozR+":</i></B></TD><TD valign=bottom><B>"+signX+"</B></TD></TR>"
></#if
><#if sign1!="" 
   ><#assign web=web+"<TR><TD valign=top width=\"18%\"><i>"+signaturaDrugiR+":</i></TD><TD valign=bottom>"+sign1+"</TD></TR>"
></#if
><#if signX!=""  || sign1!="" 
   ><#assign web=web+"<TR><TD valign=top width=\"18%\"><BR></TD><TD></TD></TR>"
></#if

...
public class UnimarcSerializer {
   ...
   */
  public static Record fromUNIMARC(int pubType, String s) {
    UFormat format = PubTypes.getPubType(pubType);
    if (format == null) {
      //log.warn("unknown format: " + pubType + ", using whole UNIMARC");
   ...
   *   written to a file).
   */
  public static String toUNIMARC(int pubType, Record record) {
  ...
  private static Log log = LogFactory.getLog(
      "com.gint.app.bisis.common.records.serializers.UnimarcSerializer");
}
